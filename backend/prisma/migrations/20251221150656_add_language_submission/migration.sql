/*
  ...
  - Added the required column `language` to the `ChallengeSubmission` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_ChallengeSubmission" ("challengeId", "code", "feedback", "id", "score", "status", "submittedAt", "userId") SELECT "challengeId", "code", "feedback", "id", "score", "status", "submittedAt", "userId" FROM "ChallengeSubmission";
